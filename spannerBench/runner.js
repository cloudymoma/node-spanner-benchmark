...
function calculateMicroBench(benchmark, data) {
  ...
  const sortedData = [].concat(rawData).sort(function(n,m){
                                                return n - m; 
                                            });
...
class Runner {
  constructor(options) {
    ...
    //added by gb
    console.log("minExecutionTime " + this.minExecutionTime);
    console.log("maxExecutionTime " + this.maxExecutionTime);
    console.log("minExecutionCount " + this.minExecutionCount);
